...
module "lambda-raw" {
    ...
    lambda_handler_name = "spotify_analytics_raw.extract_and_ingest"
    lambda_timeout = 60
    ...
    lambda_layer_zip_file = "/workspaces/terraform/spotify-analytics-on-aws-athena/spotify_layer.zip"
    lambda_layer_name = "spotify_layer"
